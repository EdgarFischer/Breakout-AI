...
class Brick(Turtle):
    def __init__(self, x_cor, y_cor,YPAD): #note that x_cor, y_cor refer to the discrete grid ~15x10. The bottom left refers to the coordinate , the center of the paddle, 
        ...
        self.color('salmon')
        self.shape('square')
        self.shapesize(stretch_wid=2.5, stretch_len=7.35) # not that stretch_len should be set to 7.5 because a brick has len 7.5. 7.35 is only set optically fo ensure
